...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('/tanah/{aset}/edit', EditAset::class)->whereNumber('aset')->withTrashed()->name('aset.edit');
        ...
        Route::get('/admin/pengaturan', App\Livewire\Admin\PengaturanDesa::class)->name('admin.pengaturan');
    });

    Route::get('/tanah/{aset}', DetailPage::class)->whereNumber('aset')->name('aset.detail'); 
